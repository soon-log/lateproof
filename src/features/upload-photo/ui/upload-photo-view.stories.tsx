...
import type { useUploadPhotoFlow } from '../model/use-upload-photo-flow';
...
const meta = {
  title: 'Features/UploadPhoto/UploadPhotoView',
  component: UploadPhotoView,
  parameters: {
    layout: 'centered'
  },
  tags: ['autodocs']
} satisfies Meta<typeof UploadPhotoView>;

export default meta;
type Story = StoryObj<typeof meta>;

export const Empty: Story = {
  render: () => <UploadPhotoView flow={createFlow()} />
};
