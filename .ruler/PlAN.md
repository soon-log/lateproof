...
1. **M1-E1-T05**: 환경 변수 구조 설계
2. **M1-E3-T04**: SG.md 기반 스타일 시스템 구축
3. **M1-E3-T05**: Storybook 설치
4. **M1-E3-T06**: Atomic UI 컴포넌트 stories 작성
...
- [ ] M1-E1-T04: Vercel 프로젝트 생성 (확인 필요)
- [ ] M1-E1-T05: 환경 변수 구조 설계 (미완료)
