...
> **Last Updated**: 2025-12-17 (SELECT_MODE/UPLOAD UI·Page 테스트/스토리 보강 + Storybook/Vitest next/image 대응 + 훅 주입형 ViewModel 지원)
...
- [x] M2-E3-T01: 이미지 업로드(Dropzone) + UI/Page 테스트/스토리 ✅ 완료

**🎉 Epic 2.2 — SELECT_MODE Step 완료!**

### 다음 작업 (우선순위 순)

1. **M2-E3-T02**: orientation fix
2. **M2-E3-T03**: 확대/이동 기능
3. **M2-E3-T04**: 편집된 좌표 데이터 생성
...
- **M2-E3**: 🚧 25% (1/4 tasks) — UPLOAD Step 진행 중
...
- [x] M2-E3-T01: 이미지 업로드(Dropzone) + UI/로직 분리 + 업로드 성공 콜백 주입(스텝 전환 분리) + Biome complexity 대응 + UI/Page 테스트/스토리
